public class MyOwnAutoShop {
    public static void main(String[] args) {
        ...
        System.out.println("The current price of the Toyota Camry is $" + camry.regularPrice);
        ...
        System.out.println("Congratulations on your purchase of your new " + camry.color + " Toyota Camry!");
